      ...
      <div className="hidden lg:flex lg:w-1/2 relative z-10 flex-col justify-between p-12">
        ...
        <div className="max-w-md">
          <blockquote className="text-2xl font-medium text-foreground leading-relaxed">
            "Pro Media House provides the most creative and efficient solutions we've ever worked with. Truly a
            game-changer."
          </blockquote>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-card/50 backdrop-blur-sm border border-white/5 rounded-xl p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground mt-2 text-sm">Start your premium digital journey today</p>
            </div>
