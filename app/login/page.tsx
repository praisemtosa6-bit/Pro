      ...
      <div className="hidden lg:flex lg:w-1/2 relative z-10 flex-col justify-between p-12">
        ...
        <div className="max-w-md">
          <blockquote className="text-2xl font-medium text-foreground leading-relaxed">
            "Pro Media House transformed our digital presence. We saw immediate results in engagement and conversions."
          </blockquote>
        ...
        <div className="flex gap-12">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">ROI Increase</p>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-card/50 backdrop-blur-sm border border-white/5 rounded-xl p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground mt-2 text-sm">Sign in to your Pro Media House account</p>
            </div>

            {/* Social sign in */}
            <div className="flex gap-3 mb-6">
              <button className="flex-1 flex items-center justify-center gap-2 py-2.5 px-4 rounded-lg border border-white/10 bg-white/5 hover:bg-white/10 transition-colors text-sm text-foreground">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    className="w-full px-4 py-2.5 pr-11 rounded-lg bg-white/5 border border-white/10 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all"
                  />
                  <button
                    type="button"
